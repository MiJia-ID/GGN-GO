...
p.add_argument('--fasta_file', type=str, default='..data/nrPDB-GO_sequences.fasta', help='Input fasta file')
p.add_argument('--esm2_model', type=str, default='../Script/ESM2/esm2_t33_650M_UR50D.pt', help='The path of esm2 model parameter.')
args = p.parse_args()
